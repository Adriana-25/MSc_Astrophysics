...
# -*- coding: utf-8 -*-
"""
Created on Mon Apr  3 00:46:13 2023
...
#planetary transits
hdulist1 = fits.open('/media/adri/ANNA/Master_Thesis/tables/lops2/planetary_transits.fits')
hdulist1.info()
...
#rrlyrae
hdulist2 = fits.open('/media/adri/ANNA/Master_Thesis/tables/lops2/rrlyrae.fits')
hdulist2.info()
...
#MS oscillator
hdulist3 = fits.open('/media/adri/ANNA/Master_Thesis/tables/lops2/ms_oscillator.fits')
hdulist3.info()
...
#rotation modulation
hdulist4 = fits.open('/media/adri/ANNA/Master_Thesis/tables/lops2/rotation_modulation.fits')
hdulist4.info()
...
#eclipsing binaries
hdulist5 = fits.open('/media/adri/ANNA/Master_Thesis/tables/lops2/eclipsing_binaries.fits')
hdulist5.info()
...
#short timescale
hdulist6 = fits.open('/media/adri/ANNA/Master_Thesis/tables/lops2/short_timescale.fits')
hdulist6.info()
...
hdulist7 = fits.open('/media/adri/ANNA/Master_Thesis/tables/lops2/long_period.fits')
hdulist7.info()
